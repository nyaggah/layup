    ...
    <Section id="layup">
      ...
      <div className="my-6 grid gap-4 sm:grid-cols-2">
        {[
          {
            title: 'Design sense',
            desc: "I've built consumer products where UX is critical. Manufacturing floor UX has different constraints, but the same principle: respect the user's context.",
          },
          {
          ...
          <div key={item.title} className="bg-secondary/30 rounded-lg p-4">
            <div className="text-foreground mb-2 font-medium">{item.title}</div>
